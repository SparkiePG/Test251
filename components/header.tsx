    ...
    >
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
        <div className="flex items-center justify-between h-20 sm:h-20 md:h-24 lg:h-24">
          ...
          <div
            className={`lg:hidden fixed left-0 right-0 top-20 sm:top-20 md:top-24 z-40 transition-all duration-300 ${
              isMenuOpen
                ? "opacity-100 visible translate-y-0"
                : "opacity-0 invisible -translate-y-2 pointer-events-none"
            }`}
          >
            <nav className="mx-4 sm:mx-6 bg-background/95 backdrop-blur-xl rounded-xl border border-border/50 shadow-xl overflow-hidden">
