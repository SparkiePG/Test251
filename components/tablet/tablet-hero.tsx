...
export default function TabletHero() {
    ...
    const handleScrollClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
        e.preventDefault()
        const element = document.getElementById("tablet-companies")
        if (element) {
    ...
    return (
        <section id="tablet-hero" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 w-full max-w-4xl mx-auto text-center px-8 flex flex-col justify-center items-center h-full pb-20">
                ...
                >
                    <h1
                        className="font-serif text-white font-medium leading-[1.1] mb-6 text-balance drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]"
